    ...
    <div class="body">
        <div class="voter_login">
            <form action='Admin3.php' method='POST'>
                ...
                <div class="details">
                    <label for="email" class="input1">Administartor ID</label><br>
                    <input type='text' class="input" name='admin_id' placeholder="Enter Administrator ID"required/><br><br>
                    ...
                    <a href="ForgotPasswordAdmin.php"><p class="input1 para">Forgot password?</p></a>
                </div>
                <div class="foot">
